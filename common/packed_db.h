...
//std::cout<<"size: "<<size<<"\tsize_in_ovlp: "<<size_in_ovlp<<std::endl;
	...
	void load_fasta_db(const char* fasta, const int max_seq_size, std::vector<std::string>& name, std::unordered_map<std::string, std::array<int, 2>>& name2id);
